...
// Change Locale, as needed
// TRANSLATE by switching languages automatically
// What language are you using?
	$chq_locale = $lang;
     if ($chq_locale == "es_ES"){setlocale(LC_ALL, 'es_ES');}
     if ($chq_locale == "es_ES"){setlocale(LC_ALL, 'es_ES');}
     else {$chq_locale = "en_EN"; setlocale(LC_ALL, 'en_EN');}

// Will include GETs:
// ALWAYS: purl
// OPTIONS: At Least one GET of any: kin_num date day_num, month_num
...
$tribes_img_dir 	= "$purl/13-moon-synchronometer/images/tribes";
...
// Moon Image and Phases
    	$moon_info .= "<div style=\"float: left; text-align: center; margin-left: 0px; margin-top: -13px;\">\n";
	ob_start();
