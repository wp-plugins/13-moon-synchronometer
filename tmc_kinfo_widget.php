...
class tmc_kinfo_widget extends WP_Widget {
 	function tmc_kinfo_widget() {
		$widget_options = array(
			'classname'=> 'tmc_kinfo_widget_class',
			'description'=> __('Show the daily 13-moon kin on your blog', 'tmc_kinfo_widget_desc'),
		);
		$this->WP_Widget('tmc_kinfo_widget',  __('13 Moon Kin', 'tmc_kinfo_widget'), $widget_options);
	}
...
// widget form creation
     function form($instance) {
	     ...
	     <p>
	     <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Widget Title', 'tmc_kinfo_widget'); ?></label>
...
// display widget
     function widget($args, $instance) {
        ...
        echo $before_widget;
        // Display the widget
        echo '<div class="widget-text tmc_kinfo_widget_box">';
...
// Include output
	$tmc_content = start_new_kinshow($instance); // Pass over some vars
	echo '<div class="tmc_kinfo_widget_textarea">'.$tmc_content.'</div>';
...
// register widget
add_action('widgets_init', create_function('', 'return register_widget("tmc_kinfo_widget");'));
